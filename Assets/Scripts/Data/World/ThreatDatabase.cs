...
/// <summary>
/// A threat placed on the city map during Setup Phase, or spawned as a PvE encounter.
...
public class Threat {
    ...
    public string MitigationCriteria; // Setup Phase: what it takes to resolve this threat
    ...
    /// <summary>Setup Phase world-threat constructor (auto-assigned ID).</summary>
