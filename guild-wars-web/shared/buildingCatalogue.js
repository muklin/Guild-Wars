...
export const MODELS = {
  houses: [
    { name: 'h1',  glbPath: '/resources/h1.glb',  width: 0.255, depth: 0.349, height: 0.403 },
    { name: 'h2',  glbPath: '/resources/h2.glb',  width: 1.458, depth: 1.996, height: 2.302 },
    { name: 'h3',  glbPath: '/resources/h3.glb',  width: 1.458, depth: 1.996, height: 2.913 },
    ...
    { name: 'h11', glbPath: '/resources/h11.glb', width: 1.993, depth: 1.515, height: 1.829 },
    { name: 'h12', glbPath: '/resources/h12.glb', width: 1.590, depth: 1.869, height: 2.009 },
    { name: 'h13', glbPath: '/resources/h13.glb', width: 2.629, depth: 1.194, height: 2.772 },
    { name: 'h14', glbPath: '/resources/h14.glb', width: 1.942, depth: 1.829, height: 1.433 },
    { name: 'h15', glbPath: '/resources/h15.glb', width: 1.939, depth: 1.679, height: 3.037 },
    { name: 'h16', glbPath: '/resources/h16.glb', width: 1.816, depth: 2.816, height: 2.235 },
    { name: 'h17', glbPath: '/resources/h17.glb', width: 1.898, depth: 1.627, height: 1.243 },
    { name: 'h18', glbPath: '/resources/h18.glb', width: 1.690, depth: 1.244, height: 2.374 },
    { name: 'h19', glbPath: '/resources/h19.glb', width: 1.725, depth: 2.306, height: 3.193 },
  ],
  markets: [
    { name: 'm1', glbPath: '/resources/m1.glb', width: 1.283, depth: 1.635, height: 2.865 },
    { name: 'm2', glbPath: '/resources/m2.glb', width: 2.478, depth: 2.924, height: 3.601 },
  ],
  towers: [
    { name: 't1', glbPath: '/resources/t1.glb', width: 1.740, depth: 1.575, height: 4.481 },
    { name: 't2', glbPath: '/resources/t2.glb', width: 1.520, depth: 1.523, height: 4.820 },
    { name: 't3', glbPath: '/resources/t3.glb', width: 2.808, depth: 2.844, height: 7.359 },
    { name: 't4', glbPath: '/resources/t4.glb', width: 1.402, depth: 2.072, height: 3.598 },
    { name: 't5', glbPath: '/resources/t5.glb', width: 2.079, depth: 1.229, height: 4.019 },
  ],
  wells: [
    { name: 'well1', glbPath: '/resources/well1.glb', width: 0.900, depth: 0.848, height: 0.829 },
  ],
  walls: [
    { name: 'wallTower', glbPath: '/resources/wallTower.glb', width: 1.421, depth: 1.421, height: 2.822 },
  ],
  special: [
    { name: 'alchemists', glbPath: '/resources/alchemists.glb', width: 2.325, depth: 1.358, height: 3.156 },
    { name: 'church',     glbPath: '/resources/church.glb',     width: 5.627, depth: 4.958, height: 7.190 },
    { name: 'forge',      glbPath: '/resources/forge.glb',      width: 2.382, depth: 2.515, height: 2.106 },
    { name: 'hall',       glbPath: '/resources/hall.glb',       width: 6.517, depth: 2.272, height: 3.873 },
    { name: 'watchmaker', glbPath: '/resources/watchmaker.glb', width: 2.132, depth: 1.349, height: 2.797 },
    { name: 'waterwheel', glbPath: '/resources/waterwheel.glb', width: 2.322, depth: 2.700, height: 3.139 },
    { name: 'colliseum',  glbPath: '/resources/colliseum.glb',  width: 12.250, depth: 13.232, height: 7.620 },
  ],
}
